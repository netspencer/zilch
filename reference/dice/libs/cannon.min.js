		...
		for (var p = y, d = f, x = m, g = w, V = b, o = 0; o !== t; o++) {
			...
			for (var E, S, s = this.neighbors[o], r = s.length, c = 0; c !== r; c++) {
				...
				;(E =
					...
					V.mult(
						1 /
							(1e-4 + this.densities[o] * this.densities[c]) *
							this.viscosity *
							N.mass,
						V
					),
	...
	;(t.Compound.prototype.calculateWorldAABB = function(t, e, i, n) {
		...
		(t.ConvexPolyhedron = function(e, i) {
			...
			;(this.clipFaceAgainstHull = function(e, i, n, o, a, r, h) {
				...
				if (0 > d)
					return console.log('--- did not find any closest face... ---'), void 0
				var m = c.faces[d]
				m.connectedFaces = []
	...
	;(t.Broadphase.prototype.needBroadphaseCollision = function(e, i) {
		return 0 === (e.collisionFilterGroup & i.collisionFilterMask) ||
			...
			: (0 === (e.motionstate & B) && !e.isSleeping()) ||
				...
				? e.shape || i.shape
					? e.shape instanceof t.Plane && i.shape instanceof t.Plane ? !1 : !0
					: !1
				: !1
	}),
